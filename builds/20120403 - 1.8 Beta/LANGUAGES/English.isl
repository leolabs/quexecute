...
[CustomMessages]
; *** QuExeCute related
RegisterProtocol=Register quexecute://-Protocol with QuExeCute (recommended)
Autostart=Start QuExeCute with Windows (recommended)
RestoreConfig=Restore Configuration file (config.xml) (not recommended)
GroupTasks=Tasks:

VisitSite=Visit QuExeCute Website
