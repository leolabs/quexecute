...
[CustomMessages]
; *** QuExeCute related
RegisterProtocol=quexecute://-Protokoll mit QuExeCute registrieren (empfohlen)
Autostart=QuExeCute mit Windows starten (empfohlen)
RestoreConfig=Konfigurationsdatei (config.xml) wiederherstellen (nicht empfohlen)
GroupTasks=Aufgaben:

VisitSite=QuExeCute Website besuchen
